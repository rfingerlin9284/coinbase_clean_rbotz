...
Runs automatically before each trading session and at mid-session.

Behaviour (adapted for 24/7 crypto markets):
...
# Default watchlist — Coinbase crypto pairs
DEFAULT_WATCHLIST = [
    "BTC-USD", "ETH-USD", "SOL-USD", "AVAX-USD", "LINK-USD",
    "DOT-USD", "POL-USD", "ADA-USD", "DOGE-USD", "UNI-USD",
    "AAVE-USD", "XRP-USD", "LTC-USD", "ATOM-USD", "NEAR-USD",
    "FIL-USD", "ALGO-USD", "XLM-USD", "SHIB-USD",
]
